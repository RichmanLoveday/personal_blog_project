                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"><img
                                    src="{{ asset('admin/assets/img/icons/category.png') }}" alt="img"><span>
                                    Category Management</span> <span class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="{{ route('admin.all.category') }}">All Categories</a></li>
                                {{-- <li><a href="addproduct.html">Enabled Categories</a></li>
                                <li><a href="addproduct.html">Disabled Categories</a></li> --}}
                            </ul>

                        </li>

                        <li class="submenu">
                            <a href="index.html"><img src="{{ asset('admin/assets/img/icons/tags.png') }}"
                                    alt="img"><span>
                                    Tags Management</span> <span class="menu-arrow"></span></a>
                            <ul>
                                <li><a href="{{ route('admin.tags') }}">All Tags</a></li>
                            </ul>
                        </li>
                        <li class="submenu">
                            <a href="javascript:void(0);"><img
                            ...
                            <ul>
                                <li><a href="{{ route('admin.articles') }}">All Articles</a></li>
