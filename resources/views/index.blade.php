                    ...
                    <div class="banner-one mt-20 mb-30">
                        ...
                        @foreach ($adverts as $advert)
                            @foreach ($advert->placements as $placement)
                                @if ($placement->page === $currentPage && $placement->position === 'whats_new_banner' && $advert->status === 'active')
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="home-banner2 d-none d-lg-block">
                            ...
                            @foreach ($adverts as $advert)
                                @foreach ($advert->placements as $placement)
                                    @if ($placement->page === $currentPage && $placement->position === 'most_popular_banner' && $advert->status === 'active')
                                        <a href="{{ $advert->url }}" target="_blank">
                                            <img src="{{ asset($placement->image) }}" alt="{{ $advert->title }}">
                                        </a>
                                        @php
