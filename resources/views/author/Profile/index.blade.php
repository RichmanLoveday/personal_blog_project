    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                <div class="profile-set">
                    ...
                    <div class="profile-top">
                        <div class="profile-content">
                            <form action="{{ route('author.update.profile.photo') }}" id="updatePhoto" method="post"
                                ...
                                <div class="profile-contentimg text-center">
                                    <img style="width:100px; height:100px;" class=" mx-1 mt-2"
                                        src="{{ !is_null($author->photo) ? asset($author->photo) : asset('admin/assets/img/icons/person_icon.png') }}"
                                        alt="img" id="blah">
                ...
                <form action="{{ route('author.profile.update') }}" id="updateProfile" method="post"
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="firstName" id="firstName" class="clearForm"
                                    value="{{ Str::ucfirst($author->firstName) }}">
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="clearForm" name="lastName" id="lastName"
                                    value="{{ Str::ucfirst($author->lastName) }}" placeholder="Castilo">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group">
                                <label>Email</label>
                                <input type="text" disabled value="{{ $author->email }}"
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group">
                                <label>Phone</label>
                                <input class="clearForm" type="text" name="phone" id="phone"
                                    value="{{ $author->phone }}" placeholder="+1452 876 5432">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <textarea id="aboutMe" name="aboutMe" style="resize:none" placeholder="About Me...." class=" form-control clearForm"
                                    name="" id="" cols="30" rows="10">{{ $author->aboutMe }}</textarea>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>

                        <div class="col-12">
                            <button id="btn-update" type="submit" class="btn btn-submit me-2">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button onclick="clearInputs()" type="button" class="close" data-dismiss="modal"
                        aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form id="changePasswordForm" action="{{ route('author.changepassword') }}"
                    onsubmit="changePassword(event)" method="POST">
                    @csrf
                    @method('PUT')
